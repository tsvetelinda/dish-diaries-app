import{a as y}from"./chunk-FLVNSE64.js";import{a as w}from"./chunk-UNSU3U4H.js";import{c as S,d as f,f as s,g as M,h}from"./chunk-XAZLOLJU.js";import"./chunk-TPPXSH5E.js";import{Ba as r,Ca as u,Qa as d,Xa as e,Ya as t,Z as x,Za as o,fb as a,gb as m,ia as p,ja as l,jb as v}from"./chunk-I5RZUSNV.js";var C=class g{constructor(i){this.apiService=i}randomDish=void 0;dishes=[];randomIndex=0;likes=0;dislikes=0;ngOnInit(){this.apiService.getDishes().subscribe(i=>{this.dishes=i,this.randomIndex=Math.floor(Math.random()*i.length),this.randomDish=this.dishes[this.randomIndex],this.likes=this.randomDish.reactions.filter(n=>n.status==="liked").length,this.dislikes=this.randomDish.reactions.filter(n=>n.status==="disliked").length})}static \u0275fac=function(n){return new(n||g)(u(w))};static \u0275cmp=x({type:g,selectors:[["app-surprise"]],standalone:!0,features:[v],decls:22,vars:4,consts:[[1,"surprise-container"],[3,"dish"],[1,"information"],[1,"prompt-msg"],[1,"reactions"],[1,"likes"],[1,"icon-container"],["version","1.0","xmlns","http://www.w3.org/2000/svg","width","100","height","100","viewBox","0 0 512.000000 512.000000","preserveAspectRatio","xMidYMid meet"],["transform","translate(0.000000,512.000000) scale(0.100000,-0.100000)","fill","#FFD400","stroke","none"],["d",`M3533 5107 c-18 -7 -218 -154 -445 -328 -227 -173 -433 -329 -458
